...
?>
    <form action="?action=update" method="POST">
        ...
        <label for="destino_de_viagem">destino_de_viagem</label>
         ...
         <label for="telefone_de_emergencias">telefone_de_emergencias</label>
         <input type="text" name="telefone_de_emergencias" value="<?php echo $telefone_de_emergencias?>">

         <label for="notas_adicionais">notas_adicionais</label>
         <input type="text" name="notas_adicionais" value="<?php echo $notas_adicionais?>">

         <label for="documentos_da_viagem">documentos_da_viagem</label>
...
<form action="?action=create" method="POST">
 ...
 <input type="text" name="numero_de_viajantes" id="numero_de_viajantes" required>
